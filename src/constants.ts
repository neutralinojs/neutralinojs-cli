export const remote = {
  binariesUrl:
    'https://github.com/neutralinojs/neutralinojs/releases/download/{tag}/neutralinojs-{tag}.zip',
  clientUrlPrefix:
    'https://github.com/neutralinojs/neutralino.js/releases/download/{tag}/neutralino.',
  templateUrl: 'https://github.com/{template}/archive/main.zip',
  releasesApiUrl:
    'https://api.github.com/repos/neutralinojs/{repo}/releases/latest',
  templateCheckUrl:
    'https://api.github.com/repos/{template}/contents/neutralino.config.json',
} as const
...
export const misc = {
  ...
  hotReloadGlobPatchRegex:
    /(<script.*src=")(.*__neutralino_globals.js)(".*><\/script>)/g,
} as const
